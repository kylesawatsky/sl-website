      ...
      $(this.element).each(function() {
        ...
        if(current.outerHeight(true) < maxHeight) {
          ...
          return true;
			...
			current.closest("section").find(".info-description").append($($this.options.moreLink).on('click', function(event) { $this.toggleSlider(this, current, event) }).addClass('readmore-js-toggle'));
